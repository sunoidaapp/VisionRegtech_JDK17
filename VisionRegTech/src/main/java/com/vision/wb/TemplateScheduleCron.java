...
public class TemplateScheduleCron {
	...
	/**
	 * ✅ 1️⃣ BATCH SUBMIT CRON Runs every 5 minutes. Does batch submission if
	 * RG_AUTO_SUBMIT_FLAG = Y.
	 */
	...
	/**
	 * ✅ 2️⃣ SINGLE SUBMIT CRON Runs every 30 seconds. Picks one eligible record and
	...
	public void dosubmit() {
		...
		if (templateScheduleVb != null && ValidationUtil.isValid(rgBuildFlag) && "Y".equalsIgnoreCase(rgBuildFlag)) {
			...
			templateScheduleCronDao.updateProcessControlheader1(processStatus, (String) exceptionCode.getResponse1(),
					(String) exceptionCode.getResponse2(), templateScheduleVb);
		} else {
