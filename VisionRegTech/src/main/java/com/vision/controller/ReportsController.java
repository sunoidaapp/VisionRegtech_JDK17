...
public class ReportsController {
	...
	// @ApiOperation(value = "Get Report List",notes = "Get List of Report on Group
	// wise",response = ResponseEntity.class)
	...
	// @ApiOperation(value = "Get Report Filter",notes = "Get Filter for both
	// Reports and Dashboard",response = ResponseEntity.class)
	...
	// @ApiOperation(value = "Get Dependency Filter Value",notes = "Get the value
	// for Dependent filter",response = ResponseEntity.class)
	...
	// @ApiOperation(value = "Get Report Data",notes = "Get the Report Data for the
	// specified Report Id",response = ResponseEntity.class)
	public ResponseEntity<JSONExceptionCode> getSubReportResultData(@RequestBody ReportsVb vObject)
			throws SQLException {
		JSONExceptionCode jsonExceptionCode = null;
		try {
...
//			reportsDao.insertReportsAudit(vObject, exceptionCode.getErrorMsg());
	...
	// @ApiOperation(value = "Get Interactive Reports List",notes = "Get the list of
	// Interactive Reports for the report id ",response = ResponseEntity.class)
	public ResponseEntity<JSONExceptionCode> getInteractiveReportsData(@RequestBody ReportsVb vObject)
			throws SQLException {
		JSONExceptionCode jsonExceptionCode = null;
		try {
	...
	// @ApiOperation(value = "Get Excel Report",notes = "Export Report Data to
	// Excel",response = ResponseEntity.class)
	public ResponseEntity<JSONExceptionCode> excelExportReport(@RequestBody ReportsVb vObject,
			HttpServletRequest request, HttpServletResponse response) {
		JSONExceptionCode jsonExceptionCode = null;
		try {
			// vObject.setActionType("Downlaod");
	...
	// @ApiOperation(value = "Get PDF Report",notes = "Export Report Data to
	// PDF",response = ResponseEntity.class)
	public ResponseEntity<JSONExceptionCode> pdfExportReport(@RequestBody ReportsVb vObject, HttpServletRequest request,
	...
	// @ApiOperation(value = "Multi Excel",notes = "Export Report Data to
	// Excel",response = ResponseEntity.class)
	public ResponseEntity<JSONExceptionCode> exportMultiPanelExcel(@RequestBody ReportsVb vObject,
			HttpServletRequest request, HttpServletResponse response) {
		JSONExceptionCode jsonExceptionCode = null;
		try {
			vObject.setActionType("Query");
	...
	// @ApiOperation(value = "Get PDF Report",notes = "Export Report Data to
	// PDF",response = ResponseEntity.class)
	public ResponseEntity<JSONExceptionCode> exportMultiPanelpdf(@RequestBody ReportsVb vObject,
			HttpServletRequest request, HttpServletResponse response) {
		JSONExceptionCode jsonExceptionCode = null;
		try {
			vObject.setActionType("Query");
	...
	// @ApiOperation(value = "Get Tree Prompt Data",notes = "Get the value for Tree
	// Prompt",response = ResponseEntity.class)
	...
	// @ApiOperation(value = "Get CB Report Data",notes = "get CB Report
	// Data",response = ResponseEntity.class)
	public ResponseEntity<JSONExceptionCode> getCBKReport(@RequestBody ReportsVb vObject, HttpServletRequest request,
			HttpServletResponse response) {
		JSONExceptionCode jsonExceptionCode = null;
		try {
			vObject.setActionType("Query");
	...
	// @ApiOperation(value = "Get Report Prompt Dependency Filter Value",notes =
	// "Get the value for Dependent filter",response = ResponseEntity.class)
