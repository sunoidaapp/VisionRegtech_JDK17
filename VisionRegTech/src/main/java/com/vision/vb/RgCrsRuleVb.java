...
public class RgCrsRuleVb extends CommonVb{
	...
	List<RgCrsRuleDetailsVb> ruleDetailsList = new ArrayList<RgCrsRuleDetailsVb>();
	...
	public List<RgCrsRuleDetailsVb> getRuleDetailsList() {
		return ruleDetailsList;
	}

	public void setRuleDetailsList(List<RgCrsRuleDetailsVb> ruleDetailsList) {
